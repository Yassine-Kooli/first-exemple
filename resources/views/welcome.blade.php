    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="#" class="btn custom-btn d-lg-none ms-auto me-4">Buy Ticket</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <a href="{{ route('register') }}" class="btn custom-btn d-lg-block d-none">Register Now!</a>
                </div>
            </div>
        </nav>
        ...
        <section class="hero-section" id="section_1">
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="{{ asset('assets/video/pexels-2022395.mp4') }}" type="video/mp4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="{{ asset('assets/images/pexels-alexander-suhorucov-6457579.jpg') }}" class="about-image img-fluid">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="{{ asset('assets/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg') }}"
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="{{ asset('assets/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg') }}"
                                    class="artists-image img-fluid">
                            </div>
                        ...
                        <div class="artists-thumb">
                            <img src="{{ asset('assets/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg') }}"
                                class="artists-image img-fluid">
